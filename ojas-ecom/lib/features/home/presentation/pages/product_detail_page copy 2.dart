...
//       } else if (match.images.isNotEmpty) {
//         _selectedImageUrl = match.images[0];
//       } else {
...
//     final availableWeightsForSize = product.variations
...
//     final bool hasStandardAttrs = uniqueSizes.isNotEmpty || uniqueColors.isNotEmpty || uniqueMaterials.isNotEmpty || availableWeightsForSize.isNotEmpty;
...
//         if (availableWeightsForSize.isNotEmpty) ...[
//           Text(
...
//             spacing: 8,
//             runSpacing: 8,
//             children: availableWeightsForSize.map((w) {
